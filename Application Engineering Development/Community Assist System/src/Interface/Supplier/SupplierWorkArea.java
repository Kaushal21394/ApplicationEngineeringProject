...
public class SupplierWorkArea extends javax.swing.JPanel {
   ...
   //private Supply sup;
    public SupplierWorkArea(JPanel userProcessContainer,UserAccount account,Organization organization,Enterprise enterprise,Ecosystem system) {
        ...
        this.system=system;
        //s= new Supplier();
         System.out.println("Supplier List size" +((DistributorOrganization) organization).getSupplierList().getSupplyList().size());
          for (Supplier supplier : ((DistributorOrganization)organization).getSupplierList().getSupplyList()) {
