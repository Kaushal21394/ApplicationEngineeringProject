...
public class ManageUserAccount extends javax.swing.JPanel {
    ...
    public void popOrganizationComboBox() {
        ...
        for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
           if(organization instanceof ChangeSeekerOrganization)
    ...
    private void populateRoleComboBox(Enterprise e){
       ...
       // for (Role role : e.getSupportedRole()){
            roleComboBox.addItem(new ChangeSeekerRole());
        }
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        if (organization instanceof ChangeSeekerOrganization){
           ...
           ((ChangeSeekerOrganization) organization).getChangeseekerlist().getChangeSeekerDirectory().add(cs);
