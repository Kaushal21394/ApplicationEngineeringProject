 ...
 * @author chava
 */
public class ReviewCommissionJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ReviewCommissionJPanel
     */
     private JPanel userProcessContainer;
    private Business business;
    private Person person;
    public ReviewCommissionJPanel(JPanel userProcessContainer, Business business, Person person) {
        initComponents();
 ...
 public void populateTable(){
    ...
    for(Order order: business.getOrderDirectory().getOrderList()){
       if(order.getPerson().getEmployeeId().equalsIgnoreCase(person.getEmployeeId())){
               ...
               row[3] = order.getSalesCommission();
               dtm.addRow(row);
    ...
    private void initComponents() {
        ...
        tblOrder.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order Id", "Market", "Customer", "Sales Commission"
            }
        ) {
        ...
        jLabel2.setText("REVIEW COMMISSION");
